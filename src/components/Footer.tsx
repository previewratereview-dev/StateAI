        ...
        <div className="py-10 sm:py-16 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 sm:gap-10 lg:gap-12">
          ...
          <div className="sm:col-span-2 lg:col-span-1">
            ...
            <div className="space-y-2 sm:space-y-3">
              ...
              <a href="https://wa.me/919186041549" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 sm:gap-3 text-xs sm:text-sm text-gray-400 hover:text-silver transition-colors duration-200">
                <svg className="w-3.5 h-3.5 sm:w-4 sm:h-4" fill="currentColor" viewBox="0 0 24 24">
