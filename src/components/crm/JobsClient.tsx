    ...
    <div>
      ...
      {jobs.length === 0 ? (
        ...
        >
          ...
          <h3 style={{ color: "#1E293B", fontSize: "1.1rem", fontWeight: 600, marginBottom: 8 }}>No jobs yet</h3>
                    ...
                    <td style={cellStyle}>
                      <button
                        ...
                        style={{
                          ...
                          fontSize: "0.72rem",
                          fontWeight: 600,
                          background: job.featured ? "rgba(245,158,11,0.12)" : "#E2E8F0",
                          color: job.featured ? "#f59e0b" : "#94A3B8",
                          border: "none",
                          cursor: "pointer",
                          fontFamily: "inherit",
                          opacity: toggling === job.id ? 0.6 : 1,
