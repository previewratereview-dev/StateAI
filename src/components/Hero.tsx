...
const stats = [
  { icon: Users, number: "100+", label: "Businesses Served" },
  { icon: Grid3x3, number: "50,000+", label: "Tasks Automated" },
  { icon: DollarSign, number: "$2M+", label: "Client Cost Savings" },
                  ...
                  return (
                    <div key={stat.label} className="flex items-center gap-1.5 sm:gap-2.5">
                      ...
                      <div className="min-w-0">
                        <div className="text-sm sm:text-lg lg:text-xl font-bold text-silver-bright truncate">{stat.number}</div>
                        <div className="text-[9px] sm:text-[10px] text-muted leading-tight truncate">{stat.label}</div>
                      </div>
                    </div>
                  );
                })}
